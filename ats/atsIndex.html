    ...
    <script>
        ...
        $(function () {
            ...
            $('#addModal').on('show.bs.modal', function () {
                alert(6);
                $('input[name="customer"]:eq(0)').prop('checked', 'true');
                $("select[name='testMachine']:eq(0)").val(null).trigger('change');
                $("select[name='testImage']:eq(1)").val(null).trigger('change');
        ...
        function  select2Init() {
            var testImage = $("select[name='testImage']");
            testImage.select2({
                    width: "100%",
                    ajax: {
            ...
            addMachine.on("select2:select",function(e){
                ...
                if ($('input[name="customer"]:eq(0)').prop('checked')){
                    $.ajax({
                        type: 'get',
                        ...
                        success: function(result){
                            ...
                            $('div[data-topic="pDmiInfo"] p:eq(0)').html(result[0].pn);
                            $('div[data-topic="pDmiInfo"] p:eq(1)').html(result[0].sn);
                            $('div[data-topic="pDmiInfo"] p:eq(2)').html(result[0].oem);
                            $('div[data-topic="pDmiInfo"] p:eq(3)').html(result[0].lanIp);
                            $('div[data-topic="pDmiInfo"] p:eq(4)').html(result[0].shelfId);
                    ...
                    $.ajax({
                        ...
                        dataType: 'json',
                        success: function(result){
                            $('div[data-topic="inputDmiInfo"] p:eq(0)').html(result[0].lanIp);
                            $('div[data-topic="inputDmiInfo"] p:eq(1)').html(result[0].shelfId);
                ...
                alert(4);
                if ($('input[name="customer"]:eq(0)').prop('checked')){
                    $('div[data-topic="pDmiInfo"]').css('display', 'none').find('p').html('');
                } else {
                    $('div[data-topic="inputDmiInfo"]').find('p').html('N/A');
                }
            });
        ...
        function addCheckBoxInit() {
            ...
            var pDmi = $('div[data-topic="pDmiInfo"]');
            var inputDmi = $('div[data-topic="inputDmiInfo"]');
            ...
            cstCh.change(function () {
                ...
                if ("customer" === vadio) {
                    alert(1);
                    pDmi.css('display', 'none');
                    inputDmi.css('display', 'block');

                    addMachine.val(null).trigger('change');
                    inputDmi.find('input').val('');
                    inputDmi.find('p').html('N/A');
                } else if("default" === vadio) {
                    alert(2);
                    addMachine.val(null).trigger('change');
                    inputDmi.css('display', 'none');
                    pDmi.css('display', 'none');
                }
                addFormValidatorInit();
        ...
        function addFormValidatorInit(){
            $('#addTaskForm').bootstrapValidator({
                        ...
                        validators: {
                            ...
                            callback: {
                                ...
                                callback: function (value, validator) {
                                    var testMachine = $("select[name='testMachine']:eq(0)").select2('data')[0].text;
                                    if (null != testMachine){
                    ...
                    testImage: {
                        ...
                        validators: {
                            ...
                            callback: {
                                ...
                                callback: function (value, validator) {
                                    var testImage = $("select[name='testImage']:eq(1)").select2('data')[0].text;
                                    console.log('get_' + value);
                ...
                var testImage = $("select[name='testImage']:eq(1)").select2('data')[0].text;
                var machineId = $("select[name='testMachine']:eq(0)").select2('val');
                ...
                if ($('input[name="customer"]:eq(0)').prop('checked')){
                    ...
                    $.ajax({
                        ...
                        data: {
                            ...
                            testImage: testImage,
                            customer: 'default',
                            addSN: $('div[data-topic="pDmiInfo"]').find('p:eq(0)').text(),
                            addPN: $('div[data-topic="pDmiInfo"]').find('p:eq(1)').text(),
                            addOem: $('div[data-topic="pDmiInfo"]').find('p:eq(2)').text(),
                            lanIp: $('div[data-topic="pDmiInfo"]').find('p:eq(3)').text(),
                            shelf: $('div[data-topic="pDmiInfo"]').find('p:eq(4)').text(),
                        },
                        success : function (result) {
                            console.log(result);
                            if (result == "success") {
                    ...
                    $.ajax({
                        ...
                        data: {
                            ...
                            testImage: testImage,
                            customer: 'customer',
                            addSN: $('div[data-topic="inputDmiInfo"]').find('input:eq(0)').val(),
                            addPN: $('div[data-topic="inputDmiInfo"]').find('input:eq(1)').val(),
                            addOem: $('div[data-topic="inputDmiInfo"]').find('input:eq(2)').val(),
                    ...
                    $.ajax({
                        ...
                        success: function (result) {
                            ...
                            if(result.flag){
                                ...
                                $("#dmiInfo").find('p:eq(1)').html(result.row['DMI_SerialNumber']);
                                $("#dmiInfo").find('p:eq(2)').html(result.row['DMI_PartNumber']);
                                $("#dmiInfo").find('p:eq(3)').html(result.row['DMI_OEMString']);
        ...
        function assignButtonInit(){
            $('#assignTask').click( function () {
                ...
                if(ckArr.length == 0){
                    ...
                    toastr.warning("Please select less then five checkbox");
                }
                    ...
                    <div class="modal-body">
                        <form class="form-horizontal form-group-sm" id="addTaskForm" method="post">
                            ...
                            <div style="display:none;" data-topic="pDmiInfo">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">ShelfID_LANID</label>
                                    <div class="col-sm-3">
                                        <p class="form-control-static"></p>
                                    </div>
                                </div>
